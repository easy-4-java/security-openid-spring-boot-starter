...
# security-openid-spring-boot-starter

**Spring Boot Starter for security-openid**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/security-openid-spring-boot-starter)](https://github.com/easy-4-java/security-openid-spring-boot-starter)
...
> **Artifact ID**：`security-openid-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**security-openid-spring-boot-starter** is a Spring Boot starter that integrates **security-openid** for applications using security-openid. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume security-openid capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using security-openid |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for security-openid |
| JDK | `17` |
| Coordinates | `io.github.easy4j:security-openid-spring-boot-starter:1.0.0-SNAPSHOT` |
| Config Prefix | `security.openid` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers security-openid beans automatically |
| Property Binding | ✅ Stable | Binds `security.openid.*` to `SecurityOpenIDAuthcProperties` |
...
|---|---|---|:---:|---|:---:|
| `security.openid.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl security-openid-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `security.openid.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/security-openid-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/security-openid-spring-boot-starter)
